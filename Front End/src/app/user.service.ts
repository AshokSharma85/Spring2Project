...
export class UserService {
  ...
  {
    return this.http.get("http://localhost:1137/login/"+phoneNumber+"/"+password,{responseType:'text'});

  }

  // public registerUser(userRef:User):Observable<any>
  // {
  //   let url="http://localhost:1137/add";
  //   return this.http.post(url,userRef,{responseType:'text'});
  // }

  // public updateUser(userId:number):Observable<any>
  // {
  //   return this.http.put("http://localhost:1137/update/"+userId,{responseType:'text'});
  // }
